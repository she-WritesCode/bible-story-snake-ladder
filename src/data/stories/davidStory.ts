...
export const DAVID_CARDS: Card[] = [
  ...
  },
  {
    ...
    type: "WISDOM",
    title: "The Poet",
    description: "Which book of the Bible contains most of the songs David wrote?",
  ...
  },
  {
    ...
    type: "WISDOM",
    title: "The Warrior",
    description: "David fought many battles. Who was the commander of his army?",
  ...
  },
  {
    ...
    type: "WISDOM",
    title: "The Prophet",
    description: "God sent a prophet to confront David about his sin with Bathsheba.",
  ...
  },
  {
    ...
    type: "PROVIDENCE",
    title: "Mighty Men",
    description: "You have found loyal friends to help you. Move forward 4 spaces.",
    effect: { move: 4 },
  },
  {
    id: "p5",
  ...
  },
  {
    ...
    description: "Jonathan makes a covenant of friendship with you, protecting you from Saul. Move forward 4 spaces.",
    effect: { move: 4 },
  },
  {
    id: "p8",
  ...
  },
  {
    ...
    description: "Abigail brings provisions and wise counsel, saving you from bloodshed. Move forward 3 spaces.",
    effect: { move: 3 },
  },
  {
    id: "p10",
    ...
    description: "You are crowned King over all Israel at Hebron. Move forward 5 spaces.",
    effect: { move: 5 },
  },
  {
    id: "p11",
  ...
  },
  {
    ...
    description: "You fled to the Philistines because you stopped trusting God. Can you overcome your fear?",
  ...
  },
  {
    ...
    description: "You counted your army to feel powerful instead of trusting God. Can you humble yourself?",
  ...
  },
  {
    ...
    description: "You almost attacked Nabal because he was rude to you. Can you show restraint?",
  ...
  },
  {
    ...
    options: [
      "He ran away",
      "He find strength in the Lord his God",
      "He fought his own men",
      "He surrendered to the Amalekites",
    ],
    answer: "He find strength in the Lord his God",
    successEffect: { move: 3 },
    failureEffect: { move: -5 },
  },
  {
    ...
    options: ["On a new cart", "By horses", "Carried on poles by the Levites", "Rolled on logs"],
  ...
  },
  {
    ...
    description: "Shimei cursed you and threw stones as you fled from Absalom. Can you show mercy?",
